...
@section('header')
<i class="ri-user-add-line"></i> Tambah Customer Baru
@endsection
        ...
        <form method="POST" action="{{ route('admin.customers.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="no_wa" id="no_wa" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: 6281234567890" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: budi@gmail.com">
                </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat" id="alamat" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Nama jalan, nomor rumah, nama perumahan, blok, RT/RW..." required></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="kelurahan" id="kelurahan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: Sidomulyo Barat">
                </div>
                <!-- Kecamatan -->
                <div>
                    <label for="kecamatan" class="block text-sm font-semibold text-gray-700 mb-1">Kecamatan</label>
                    <input type="text" name="kecamatan" id="kecamatan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: Tampan">
                </div>
                <!-- Kota -->
                <div>
                    <label for="kota" class="block text-sm font-semibold text-gray-700 mb-1">Kota / Kabupaten</label>
                    <input type="text" name="kota" id="kota" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" value="Pekanbaru" required>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <div class="relative flex items-center">
                            ...
                            <input type="text" name="latitude" id="latitude" class="w-full pl-11 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: 0.46820000">
                        </div>
                    </div>
                    <div>
                        <div class="relative flex items-center gap-2">
                            <div class="relative flex-1 flex items-center">
                                ...
                                <input type="text" name="longitude" id="longitude" class="w-full pl-11 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: 101.37890000">
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <!-- Sumber Info -->
                <div>
                    <label for="sumber_info" class="block text-sm font-semibold text-gray-700 mb-1">Sumber Info (tahu PHC dari mana?)</label>
                    <select name="sumber_info" id="sumber_info" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                        ...
                        <option value="Teman / Kerabat">Rekomendasi Teman / Kerabat</option>
            ...
            <div class="mb-6">
                ...
                <textarea name="catatan" id="catatan" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Catatan khusus mengenai pelanggan (misalnya: 'mempunyai anjing galak', 'minta dibersihkan hari libur saja', dsb)..."></textarea>
            </div>
