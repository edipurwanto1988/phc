...
@section('header')
<i class="ri-edit-box-line"></i> Edit Artikel: {{ $post->judul }}
@endsection
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul" id="judul" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" value="{{ $post->judul }}" required oninput="generateSlug()">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="slug" id="slug" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" value="{{ $post->slug }}" required>
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" id="excerpt" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">{{ $post->excerpt }}</textarea>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl space-y-4">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs bg-white" required>
                                <option value="draft" {{ $post->status === 'draft' ? 'selected' : '' }}>Draft (Simpan dulu)</option>
                                <option value="published" {{ $post->status === 'published' ? 'selected' : '' }}>Published (Terbit langsung)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $post->gambar_utama) }}" alt="Current Image" class="w-full h-24 object-cover rounded border border-gray-200">
                    ...
                    <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs" value="{{ $post->meta_title }}" placeholder="Judul pencarian Google...">
                        </div>

                        <!-- Meta Description -->
                        <div>
                            <label for="meta_description" class="block text-xs font-semibold text-gray-500 uppercase mb-1">Meta Description (SEO)</label>
                            <textarea name="meta_description" id="meta_description" rows="3" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs" placeholder="Deskripsi pencarian Google...">{{ $post->meta_description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
