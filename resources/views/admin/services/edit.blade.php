...
<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <!-- Nama di Invoice -->
                <div>
                    <label for="nama_invoice" class="block text-sm font-semibold text-gray-700 mb-1">Nama di Invoice (Opsional)</label>
                    <input type="text" name="nama_invoice" id="nama_invoice" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: Gen Clean" value="{{ $service->nama_invoice }}">
                </div>
                <!-- Kategori Jasa -->
                <div>
