        ...
        <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_invoice" id="nama_invoice" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: Gen Clean">
                </div>
                <!-- Kategori Jasa -->
                <div>
