                                ...
                                @if($assignment->foto_sebelum)
                                    <div class="relative group w-full h-20 rounded-lg overflow-hidden border border-gray-200 bg-black shadow-sm">
                                        ...
                                        <div class="absolute inset-0 flex items-center justify-center gap-1.5 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <!-- View Button (Opens in new tab directly to bypass CORS OpaqueResponseBlocking) -->
                                            <a href="{{ $assignment->foto_sebelum }}" target="_blank" class="p-1.5 bg-white/20 hover:bg-white/40 text-white rounded-md text-xs font-semibold flex items-center justify-center" title="Buka Gambar">
                            ...
                            <div class="space-y-1">
                                ...
                                @if($assignment->foto_sesudah)
                                    <div class="relative group w-full h-20 rounded-lg overflow-hidden border border-gray-200 bg-black shadow-sm">
                                        ...
                                        <div class="absolute inset-0 flex items-center justify-center gap-1.5 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <!-- View Button (Opens in new tab directly to bypass CORS OpaqueResponseBlocking) -->
                                            <a href="{{ $assignment->foto_sesudah }}" target="_blank" class="p-1.5 bg-white/20 hover:bg-white/40 text-white rounded-md text-xs font-semibold flex items-center justify-center" title="Buka Gambar">
                                                <i class="ri-eye-line text-sm"></i>
                                            </a>
                                            <!-- Delete Button -->
