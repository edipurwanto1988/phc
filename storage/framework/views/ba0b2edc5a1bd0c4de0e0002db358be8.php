<?php $__env->startSection('title', 'Tambah Item Menu'); ?>
<?php $__env->startSection('header'); ?>
<i class="ri-add-circle-line"></i> Tambah Item Menu
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200" x-data="{ selectedUrl: '' }">
        <form method="POST" action="<?php echo e(route('admin.menu.store')); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: Beranda, Hubungi Kami" required>
                </div>

                <!-- Icon -->
                <div>
                    <label for="icon" class="block text-sm font-semibold text-gray-700 mb-1">Icon Remix (opsional)</label>
                    <input type="text" name="icon" id="icon" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: ri-home-4-line">
            ...
            <div class="mb-4">
                ...
                <select id="url_picker" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white mb-2" x-model="selectedUrl" @change="document.getElementById('url').value = selectedUrl">
                    ...
                    <optgroup label="<?php echo e($group); ?>">
                        ...
                        <option value="<?php echo e($opt['value']); ?>"><?php echo e($opt['label']); ?> (<?php echo e($opt['value']); ?>)</option>
                ...
                <input type="text" name="url" id="url" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: /, /layanan, https://google.com" required>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select name="posisi" id="posisi" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white" required>
                        <option value="header" selected>Header (Navigasi Atas)</option>
                        <option value="footer">Footer (Kaki Halaman)</option>
                        <option value="sidebar">Sidebar Admin</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    ...
                    <select name="target" id="target" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white" required>
                        <option value="_self" selected>_self (Tab saat ini)</option>
                ...
                <div>
                    ...
                    <input type="number" name="urutan" id="urutan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" value="0" min="0" required>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/admin/menu/create.blade.php ENDPATH**/ ?>