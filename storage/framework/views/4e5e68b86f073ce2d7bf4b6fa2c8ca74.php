<?php $__env->startSection('title', 'Hubungi Kami - PHC Pekanbaru'); ?>
            ...
            <div class="bg-white p-6 md:p-8 border border-border rounded-2xl shadow-sm space-y-6">
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-text-primary mt-1 leading-relaxed">
                            <?php echo e(\App\Models\Setting::get('address', 'Jl. HR. Soebrantas, Pekanbaru, Riau')); ?>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-text-primary mt-1">
                            <?php echo e(\App\Models\Setting::get('phone', '0761-12345')); ?>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="https://wa.me/<?php echo e(\App\Models\Setting::get('whatsapp', '6281234567890')); ?>" target="_blank" class="text-sm font-bold text-primary hover:underline mt-1 block">
                            +<?php echo e(\App\Models\Setting::get('whatsapp', '6281234567890')); ?>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:<?php echo e(\App\Models\Setting::get('email', 'info@phc-pekanbaru.com')); ?>" class="text-sm font-semibold text-text-primary hover:text-primary transition-colors mt-1 block">
                            <?php echo e(\App\Models\Setting::get('email', 'info@phc-pekanbaru.com')); ?>
        ...
        <div class="lg:col-span-7">
            <div class="bg-white p-4 border border-border rounded-2xl shadow-sm h-full flex flex-col justify-between">
                <div class="w-full rounded-xl overflow-hidden border border-gray-100 flex-1 min-h-[350px] lg:min-h-[450px]">
                    <?php echo \App\Models\Setting::get('google_maps_embed', '<div class="w-full h-full bg-gray-100 flex items-center justify-center text-gray-400 font-semibold">Map tidak terkonfigurasi</div>'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/pages/contact.blade.php ENDPATH**/ ?>