...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="card p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-sm text-gray-500 font-medium"><?php echo e(auth()->user()->role->name === 'Cleaner' ? 'Gaji Diterima' : 'Total Pendapatan'); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
    ...
    <div class="lg:col-span-2 card p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
            <i class="ri-line-chart-line text-blue-600"></i> <?php echo e(auth()->user()->role->name === 'Cleaner' ? 'Tren Pendapatan Gaji Bulanan' : 'Tren Pendapatan & Pengeluaran Bulanan'); ?>
                    ...
                    <td class="py-3.5 px-6 text-sm font-semibold text-gray-800 text-right">
                        <?php if(auth()->user()->role->name === 'Cleaner'): ?>
                            ...
                            <div class="text-[9px] <?php echo e(($myAssign->status_gaji ?? '') === 'sudah_dibayar' ? 'text-green-600' : 'text-red-500'); ?> font-bold">
                                <?php echo e(($myAssign->status_gaji ?? '') === 'sudah_dibayar' ? 'Sudah Dibayar' : 'Belum Dibayar'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '<?php echo e($isCleaner ? 'Gaji Diterima (Rp)' : 'Pendapatan (Rp)'); ?>',
