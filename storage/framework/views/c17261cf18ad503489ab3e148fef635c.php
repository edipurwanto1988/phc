<?php $__env->startSection('title', 'Buat Laman Baru'); ?>
<?php $__env->startSection('header'); ?>
<i class="ri-add-circle-line"></i> Buat Laman Baru
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200">
    <form method="POST" action="<?php echo e(route('admin.halaman.store')); ?>" enctype="multipart/form-data" id="halaman-form">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="judul" id="judul" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Contoh: Ketentuan Layanan (Terms of Service)" required oninput="generateSlug()">
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400 mt-1">Maks. 2MB (jpg/png/webp).</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 pt-6 border-t border-gray-100 mt-6">
            ...
            <a href="<?php echo e(route('admin.halaman.index')); ?>" class="btn border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium px-5 py-2.5 rounded-lg text-sm transition-all">
                Batal
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/admin/halaman/create.blade.php ENDPATH**/ ?>