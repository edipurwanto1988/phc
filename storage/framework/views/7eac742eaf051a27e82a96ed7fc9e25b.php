                ...
                <section class="relative hidden overflow-hidden bg-primary p-10 text-white lg:flex lg:flex-col lg:justify-between">
                    ...
                    <div class="relative">
                        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center">
                            <img src="<?php echo e(asset('header.png')); ?>" alt="Pekanbaru Home Cleaning" class="h-14 w-auto object-contain">
                        </a>
                    </div>
                    ...
                    <?php echo csrf_field(); ?>
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" class="block h-12 w-full rounded-xl border-slate-200 bg-slate-50 pl-11 pr-4 text-sm font-medium text-slate-800 shadow-sm transition focus:border-primary focus:bg-white focus:ring-primary" placeholder="admin@pekanbaruhomecleaning.com" required autofocus autocomplete="email">
                                </div>
                            </div>
                            ...
                            <?php if(\App\Models\Setting::get('login_captcha') === 'iya'): ?>
                            <div>
                            ...
                            <a href="<?php echo e(route('auth.google.redirect')); ?>" class="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100">
                        ...
                        <div class="mt-8 flex items-center justify-between border-t border-slate-100 pt-5 text-xs text-slate-400">
                            ...
                            <a href="<?php echo e(route('home')); ?>" class="font-semibold text-primary hover:text-primary-dark">Kembali ke website</a>
                        </div>
                    </div>
                </section>
            </div>
...
<?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>