            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="role_id" id="role_id" class="input w-full" required>
                        ...
                        <option value="<?php echo e($role->id); ?>" data-role-name="<?php echo e(strtolower($role->name)); ?>" <?php echo e(old('role_id') == $role->id ? 'selected' : ''); ?>><?php echo e($role->name); ?></option>
                ...
                <div class="p-4 bg-blue-50/70 border border-blue-200 rounded-xl space-y-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                        <label class="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg cursor-pointer hover:border-blue-400 hover:bg-blue-50/30 transition-all">
                            <input type="radio" name="jenis" value="Tetap" class="text-blue-600 focus:ring-blue-500 h-4 w-4" <?php echo e(old('jenis') === 'Tetap' ? 'checked' : ''); ?>>
                            <div>
                        ...
                        <label class="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg cursor-pointer hover:border-blue-400 hover:bg-blue-50/30 transition-all">
                            <input type="radio" name="jenis" value="Mitra" class="text-blue-600 focus:ring-blue-500 h-4 w-4" <?php echo e(old('jenis') === 'Mitra' ? 'checked' : ''); ?>>
                            <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/admin/users/create.blade.php ENDPATH**/ ?>