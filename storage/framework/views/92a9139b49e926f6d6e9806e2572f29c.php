<?php $__env->startSection('title', $service->nama . ' - PHC Pekanbaru'); ?>
<?php $__env->startSection('meta_description', $service->deskripsi_singkat ?? $service->deskripsi); ?>
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 py-12">
    ...
    <nav class="flex text-xs text-gray-500 mb-6 font-medium">
        ...
        <span class="mx-2 text-gray-300">/</span>
        <span class="text-gray-700 font-bold truncate"><?php echo e($service->nama); ?></span>
    </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 md:p-8 border border-border rounded-xl shadow-sm space-y-6">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center">
                        <i class="<?php echo e($service->category->icon ?? 'ri-sparkling-line'); ?> text-2xl"></i>
                    </div>
                    <div>
                        <span class="text-xs bg-slate-100 text-slate-650 px-2 py-0.5 rounded font-bold uppercase"><?php echo e($service->category->nama); ?></span>
                        <h1 class="text-2xl md:text-3xl font-extrabold text-text-primary leading-tight mt-1"><?php echo e($service->nama); ?></h1>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-xl border border-gray-150">
                    <div>
                        ...
                        <span class="text-base font-extrabold text-blue-600">Rp <?php echo e(number_format($service->harga, 0, ',', '.')); ?></span>
                        <span class="text-xs text-gray-550">/ <?php echo e($service->satuan); ?></span>
                    </div>
                    <div>
                        ...
                        <span class="text-sm font-bold text-gray-800 flex items-center gap-1 mt-0.5">
                            <i class="ri-time-line"></i> <?php echo e($service->durasi_estimasi ?? '60'); ?> menit
                        </span>
                    </div>
                    <div>
        ...
        <div class="space-y-6">
            ...
            <div class="card p-6 bg-blue-55 border border-blue-200 rounded-xl shadow-sm text-center">
                ...
                <a href="https://wa.me/<?php echo e($whatsapp); ?>?text=<?php echo e($text); ?>" target="_blank" class="w-full btn bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold py-2.5 rounded-lg flex items-center justify-center gap-1.5 shadow-sm transition-all mb-3">
                    Hubungi via WhatsApp <i class="ri-whatsapp-line text-sm"></i>
                </a>
                
                <a href="tel:<?php echo e(\App\Models\Setting::get('phone', '0761-12345')); ?>" class="w-full btn border border-gray-300 hover:bg-white text-gray-700 text-xs font-bold py-2.5 rounded-lg flex items-center justify-center gap-1.5 transition-all bg-white">
            ...
            <div class="card p-6 bg-white border border-border rounded-xl">
                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $relatedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex gap-3 overflow-hidden items-center">
                        <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center shrink-0">
                            <i class="<?php echo e($rService->category->icon ?? 'ri-sparkling-line'); ?> text-lg"></i>
                        </div>
                        <div class="overflow-hidden">
                            <a href="/layanan/<?php echo e($rService->slug); ?>" class="text-sm font-semibold text-text-primary hover:text-primary leading-snug line-clamp-1 block"><?php echo e($rService->nama); ?></a>
                            <span class="text-xs font-bold text-blue-600 block mt-0.5">Rp <?php echo e(number_format($rService->harga, 0, ',', '.')); ?></span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/pages/services/show.blade.php ENDPATH**/ ?>