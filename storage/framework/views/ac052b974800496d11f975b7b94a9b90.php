<?php $__env->startSection('title', 'PHC — Pekanbaru Home Cleaning | Jasa Cleaning Profesional #1 di Pekanbaru'); ?>
            ...
            <div class="flex flex-col md:flex-row items-center gap-10 md:gap-12">
                ...
                <div class="w-full md:w-2/3 text-center md:text-left">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                        ...
                        ?>
                        <a href="https://wa.me/<?php echo e($whatsapp); ?>?text=Halo%20PHC,%20saya%20ingin%20pesan%20jasa%2520cleaning"
                           target="_blank"
                ...
                <div class="w-full md:w-1/3 flex justify-center md:justify-end">
                    <div class="relative">
                        <img src="<?php echo e(asset('images/phc-team.webp')); ?>"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="card-hover bg-white rounded-lg border border-border p-6 flex flex-col justify-between">
                    <a href="/layanan/<?php echo e($service->slug); ?>" class="block group">
                        <div class="w-10 h-10 <?php echo e($bgClass); ?> rounded-lg flex items-center justify-center mb-4">
                            <i class="<?php echo e($iconClass); ?> text-xl"></i>
                        </div>
                        <h3 class="text-base font-semibold text-text-primary group-hover:text-primary transition-colors"><?php echo e($service->nama); ?></h3>
                        <p class="mt-1 text-sm text-text-secondary leading-relaxed line-clamp-3"><?php echo e(strip_tags($service->deskripsi_singkat ?? $service->deskripsi)); ?></p>
                    </a>
                ...
                <div class="bg-surface rounded-xl border border-border p-6 flex flex-col justify-between shadow-sm">
                    <div>
                        ...
                        <p class="text-sm text-text-secondary leading-relaxed italic">
                            "<?php echo e(strip_tags($testimonial->konten)); ?>"
                        </p>
                    </div>
                    <div class="mt-6 flex items-center gap-3 pt-4 border-t border-gray-100">
                        <div class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs shrink-0">
                            <?php echo e(strtoupper(substr($testimonial->nama, 0, 1))); ?>

                        </div>
                        <div>
                            <p class="text-sm font-bold text-text-primary leading-none"><?php echo e($testimonial->nama); ?></p>
                    ...
                    <div>
                        <div class="aspect-[16/10] bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center overflow-hidden border-b border-border">
                            <?php if($post->gambar_utama): ?>
                                <img src="<?php echo e(asset('storage/' . $post->gambar_utama)); ?>" alt="<?php echo e($post->judul); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <div class="p-5">
                            <div class="flex items-center gap-2 mb-2">
                                <span class="text-xs text-text-secondary"><?php echo e($post->published_at ? $post->published_at->format('d M Y') : $post->created_at->format('d M Y')); ?></span>
                                <span class="text-xs text-border">•</span>
                                <span class="text-xs text-primary font-bold">Kebersihan</span>
                            </div>
                            <h3 class="text-base font-bold text-text-primary leading-snug line-clamp-2"><?php echo e($post->judul); ?></h3>
                            <p class="mt-2 text-sm text-text-secondary leading-relaxed line-clamp-2"><?php echo e(strip_tags($post->excerpt ?? $post->konten)); ?></p>
                        </div>
                    </div>
                    <div class="px-5 pb-5 pt-2">
                        <a href="/blog/<?php echo e($post->slug); ?>" class="inline-flex items-center gap-1 text-sm font-semibold text-primary hover:text-primary-dark transition-colors">
                            Baca selengkapnya
                            <i class="ri-arrow-right-line"></i>
                        </a>
                    </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20">
            <div class="bg-primary rounded-xl p-8 md:p-12 text-center shadow-lg">
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="https://wa.me/<?php echo e($whatsapp); ?>?text=Halo%20PHC,%20saya%20ingin%20pesan%2520jasa%2520cleaning"
                       target="_blank"
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/CascadeProjects/PHC/laravel/resources/views/pages/home.blade.php ENDPATH**/ ?>