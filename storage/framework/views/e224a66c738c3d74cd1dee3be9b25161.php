            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4">
                        ...
                        <?php if($user->jenis): ?>
                        <span class="ml-1 px-2 py-0.5 text-[11px] font-medium rounded-full <?php echo e($user->jenis === 'Tetap' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'); ?>">
                            <?php echo e($user->jenis); ?>
